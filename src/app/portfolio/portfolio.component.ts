...
//       id: 1,
//       name: 'Educator: Learn For Free',
//       summary: 'This software contains features like compilation of best video lecture, Hand written notes of all the lecture, Discussion forum , Blog section and many more.',
//       description: 'This project is a comprehensive educational platform designed to provide free learning resources for computer science students. The main goal is to offer a variety of materials, including lecture notes, coding tutorials, and GATE preparation content, to support students in their academic journey. The platform includes sections for different types of resources such as notes, coding exercises, and signup forms for personalized content. Developed using HTML, CSS, and JavaScript, the project ensures a user-friendly interface and easy navigation. The repository is organized into various directories like assets, contact, gate, notes, and signup to maintain a clean and modular structure. The project is hosted on GitHub Pages, making it easily accessible to users. It follows best practices for web development and includes detailed documentation to help contributors understand the project structure and contribute effectively.',      
//       projectLink: 'https://kranubhav.github.io/Educator-Learn-for-free/',
//       tags: [Tag.HTML5, Tag.CSS3, Tag.JAVASCRIPT],
//       pictures: ["../../assets/Screenshot (19).png", "../../assets/Screenshot (20).png", "../../assets/Screenshot (21).png", "../../assets/Screenshot (22).png", "../../assets/Screenshot (23).png", "../../assets/Screenshot (24).png", "../../assets/Screenshot (25).png"]
//     },
//     // {
